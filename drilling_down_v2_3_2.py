...
def dict_to_csv(dictionary, name):
    with open('dataSNO/{file_name}.csv'.format(file_name = name), 'w') as f:
        n = 0
...
def finished_dict_export():
    with open('dataSNO/exported_files.txt', 'w') as f:
...
#gene storage, input
genes_of_interest = ['ENSG00000263934.4', 'ENSG00000265185.5', 'ENSG00000262074.6','ENSG00000264940.4', 'ENSG00000277947.1']
house_keepers = ['ENSG00000156482.10']
...
with open('dataSNO/exported_data.csv', 'w') as f:
    n = 0
